...
const Projects = () => {
  ...
  return (
    <section className="px-6 py-10" id="projects">
        <h1 className="text-4xl md:text-6xl font-medium tracking-tight ">Projects</h1>
                    ...
                    />
                        ...
                        >
                            ...
                            <div className="flex flex-col justify-between">
                                ...
                                <a href={project.link} target="_blank" rel="noopener norefferer" className="bg-white text-stone-900 rounded-full py-2 px-2 w-32 text-sm hover:bg-gray-100 text-center">
                                    View on GitHub
                                </a>
                            </div>
                        </div>    
